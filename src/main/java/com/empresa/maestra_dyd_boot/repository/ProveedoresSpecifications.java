...
public class ProveedoresSpecifications {

    private ProveedoresSpecifications() {
    }

    public static Specification<Proveedores> conFiltros(String buscador, LocalDate fechaPrograma,
        ...
        return (root, query, cb) -> {
            ...
            if (buscador != null && !buscador.isBlank()) {
                ...
                var porNit = cb.like(cb.lower(root.get("nitProveedor")), patron);
