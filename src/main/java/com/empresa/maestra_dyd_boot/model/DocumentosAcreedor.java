...
@Entity
@Table(name = "`DocumentosAcreedor`")
public class DocumentosAcreedor {
    ...
    @Column(name = "nit_acreedor", length = 30)
    ...
    public String getNitAcreedor() { return nitAcreedor; }
    public void setNitAcreedor(String nitAcreedor) { this.nitAcreedor = nitAcreedor; }
