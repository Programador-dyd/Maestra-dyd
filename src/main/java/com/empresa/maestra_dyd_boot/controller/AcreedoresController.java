...
@Controller
public class AcreedoresController {

    private final AcreedoresService acreedoresService;

    public AcreedoresController(AcreedoresService acreedoresService) {
    ...
    public String listar(
        ...
        Page<Acreedores> resultado = acreedoresService.buscarPaginado(buscador, fechaPrograma, fechaSiesa, estadoDocumentacion, estado, pagina);

        model.addAttribute("acreedores", resultado.getContent());
    ...
    @PostMapping("/acreedores/{nit}/archivar")
    public String archivar(@PathVariable("nit") String nit) {
        acreedoresService.archivar(nit);
        return "redirect:/acreedores";
    }

    @PostMapping("/acreedores/{nit}/restaurar")
    public String restaurar(@PathVariable("nit") String nit) {
        acreedoresService.restaurar(nit);
        return "redirect:/acreedores";
    }
